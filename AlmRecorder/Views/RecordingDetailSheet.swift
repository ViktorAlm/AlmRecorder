...
struct RecordingDetailSheet: View {
    ...
    private var exportBar: some View {
        HStack {
            ...
            // Transcript cleanup: detect hallucinated lines + verify suspicious ones against audio
            if isCleanupRunningForThisRecording {
                ...
                .help(TranscriptVerificationService.shared.isAvailable
                      ? "Find hallucinated lines and verify suspicious ones against the audio with Gemma"
                      : "Detect hallucinated lines (download a Gemma model in Models for the audio double-check)")
            }
